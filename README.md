...
* Alpine Linux 3.16
* OpenJDK JRE 8u212
* Nexus Repository Manager OSS 3.51.0 ([release notes](https://help.sonatype.com/repomanager3/product-information/release-notes/2023-release-notes/sonatype-nexus-repository-3.51.0-release-notes))
...
```shell
docker run -p 8081:8081 --name nexus quay.io/travelaudience/docker-nexus:3.51.0-01
```
