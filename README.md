...
* Alpine Linux 3.10
* OpenJDK JRE 8u212
* Nexus Repository Manager OSS 3.22.1-02 ([release notes](https://help.sonatype.com/repomanager3/release-notes/2020-release-notes#id-2020ReleaseNotes-RepositoryManager3.22.1))
...
```
docker run -p 8081:8081 --name nexus quay.io/travelaudience/docker-nexus:3.22.1-02
```
