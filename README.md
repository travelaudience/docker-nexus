...
* Alpine Linux 3.12
* OpenJDK JRE 8u212
* Nexus Repository Manager OSS 3.29.2 ([release notes](https://help.sonatype.com/repomanager3/release-notes#ReleaseNotes-NexusRepositoryManager3.29.2))
...
```
docker run -p 8081:8081 --name nexus quay.io/travelaudience/docker-nexus:3.29.2
```
